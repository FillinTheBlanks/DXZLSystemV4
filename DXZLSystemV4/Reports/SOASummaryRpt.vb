...
Public Class SOASummaryRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DXZLSystemV4.SOASummaryRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSOASummaryRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SOASummaryRpt = New SOASummaryRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function

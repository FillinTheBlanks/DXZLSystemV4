...
Public Class PaymentReceiptRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DXZLSystemV4.PaymentReceiptRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paramsCompany() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paramsPreparedby() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPaymentReceiptRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentReceiptRpt = New PaymentReceiptRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function

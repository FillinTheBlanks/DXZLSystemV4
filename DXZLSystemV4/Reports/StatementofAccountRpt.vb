...
Public Class StatementofAccountRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DXZLSystemV4.StatementofAccountRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatementofAccountRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatementofAccountRpt = New StatementofAccountRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CashValeEdit
    ...
    Private Sub SaveChanges(ByVal status As Integer)
        ...
        Try
            RefreshCode("CV", "CashVale", txtRefNum, Me)
            ...
            With dacp
                ...
                .SelectCommand.CommandText = "uspCashValeAE"
                ...
                .SelectCommand.CommandText = "SELECT TOP 1 RefBHID FROM vwCashValeFile WHERE RefNum='" & txtRefNum.Text & "'"
        ...
        Finally
            ...
            With frmList
                PublicFilterData(Now.Year.ToString, "RefDate", .cmbColumn, "spSelect_CashValebyFilter" _
    ...
    Private Sub CashValeEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown, txtCustomerName.KeyDown, txtAmount.KeyDown, txtRemarks.KeyDown, btnSaveChanges.KeyDown, btnCancel.KeyDown, btnSearch.KeyDown
    ...
    Private Sub CashValeEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        RefreshCode("CV", "CashVale", txtRefNum, Me)
        RefreshCode("PY", "PaymentBH", txtPyRefNum, Me)
        txtInterest.Text = "5"
        ...
        'bsd.DataSource = GetType(MyCashValeRecord)
        'Dim cvrec As MyCashValeRecord = New MyCashValeRecord
    End Sub

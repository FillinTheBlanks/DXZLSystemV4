...
Public Class CashAdvance
    ...
    Private Sub txtFilter_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFilter.KeyDown
        If e.KeyData = Keys.Enter Then
            ...
            PublicFilterData(txtFilter.Text, cmbColumn.SelectedItem.ToString, cmbColumn, "spSelect_CashAdvancebyFilter" _
    ...
    Private Sub btnNewItem_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnNewItem.ItemClick
        ...
        Dim bnedit As New CashAdvanceEdit
        With bnedit
            ...
            .bsd.DataSource = GetType(MyCashAdvanceRecord)
            Dim srec As MyCashAdvanceRecord = New MyCashAdvanceRecord
            'srec.CustomerID = 0
            srec.InterestRate = 5
            srec.Amount = 0
            .bsd.Add(srec)
    ...
    Private Sub CashAdvance_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Cursor = Cursors.WaitCursor
        PublicFilterData(Now.Year.ToString, "RefDate", cmbColumn, "spSelect_CashAdvancebyFilter" _
                             , dtView, bsd, dgList, dvList)
        HideColumn()

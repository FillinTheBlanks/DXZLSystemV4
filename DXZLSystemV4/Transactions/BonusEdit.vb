...
Public Class BonusEdit
    ...
    Private Sub SaveChanges(ByVal status As Integer)
        ...
        Try
            RefreshCode("BN", "Bonus", txtRefNum, Me)
            ...
            With dacp
                ...
                .SelectCommand.CommandText = "uspBonusAE"
                With .SelectCommand.Parameters
                    ...
                    .AddWithValue("@BonusID", 6)
                    .AddWithValue("@RefDate", MDIParent1.tsDateTimeChanger.Text)
                    .AddWithValue("@Amount", txtAmount.Text)
                    .AddWithValue("@InterestRate1", txtInterest.Text)
                    .AddWithValue("@DateCutOff", "1900-01-01 00:00:00.000")
                    .AddWithValue("@InterestRate2", 0)
                    .AddWithValue("@InterestRate3", 0)
                    .AddWithValue("@TransactionID", 32)
                ...
                .SelectCommand.CommandText = "SELECT TOP 1 RefBHID FROM vwBonusFile WHERE RefNum='" & txtRefNum.Text & "'"
    ...
    Private Sub BonusEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown, txtCustomerName.KeyDown, txtAmount.KeyDown, txtRemarks.KeyDown, btnSaveChanges.KeyDown, btnCancel.KeyDown, btnSearch.KeyDown
    ...
    Private Sub BonusEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        RefreshCode("BN", "Bonus", txtRefNum, Me)
        RefreshCode("PY", "PaymentBH", txtPyRefNum, Me)

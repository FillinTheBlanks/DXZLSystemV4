...
Public Class CashVale
    ...
    Private Sub txtFilter_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFilter.KeyDown
        If e.KeyData = Keys.Enter Then
            ...
            PublicFilterData(txtFilter.Text, cmbColumn.SelectedItem.ToString, cmbColumn, "spSelect_CashValebyFilter" _
    ...
    Private Sub btnNewItem_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnNewItem.ItemClick
        ...
        Dim cvedit As New CashValeEdit
        With cvedit
            ...
            Dim srec As MyCashValeRecord = New MyCashValeRecord
            'srec.CustomerID = 0
            srec.InterestRate = 5
            srec.Amount = 0
            .bsd.Add(srec)
            ...
            .DxErrorProvider1.ContainerControl = cvedit
    ...
    Private Sub CashVale_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Cursor = Cursors.WaitCursor
        PublicFilterData(Now.Year.ToString, "RefDate", cmbColumn, "spSelect_CashValebyFilter" _
                             , dtView, bsd, dgList, dvList)
        HideColumn()
    ...
    Private Sub dvList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dvList.DoubleClick
        ...
        With cvedit
            ...
            srec.InterestRate = Double.Parse(dvList.GetRowCellValue(i, dvList.Columns("InterestRate")).ToString())
